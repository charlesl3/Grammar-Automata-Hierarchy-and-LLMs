...
##########################################################################
# GRAMMAR TEACHING PROMPT (NO TERMINAL LIST SHOWN)
##########################################################################
...
- The Output can be just empty, say []
"""
...
def generate_prefixes(grammar, start="S", num_sentences=20):
    ...
    for _ in range(num_sentences):
        ...
        # expand into a complete terminal sentence
        for _ in range(40):
...
##########################################################################
# 3. Predict next terminal using LOCAL Llama via Ollama
##########################################################################
...
##########################################################################
# 7. Full Wide Grammar (same difficulty, more choices)
##########################################################################
