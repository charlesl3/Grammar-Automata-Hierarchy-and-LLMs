...
###############################################################################
# 3. Predict next terminal using local Mistral Nemo (Ollama)
###############################################################################
...
def predict_next(prefix):
    ...
    # For /api/generate with stream=False, response has a "response" field
...
def run_model(grammar, num_sentences=10):
    ...
    print("\n=== Accuracy Summary (Mistral Nemo via Ollama) ===")
...
if __name__ == "__main__":
    print("Running Mistral Nemo (local via Ollama)...\n")
